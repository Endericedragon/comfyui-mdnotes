import { L as v, E as i, C as _ } from "./index-Dowp-Nzo.mjs";
import { s as W, t as e, a as g, L as x, f as p, i as U, j as V, c as E } from "./main-DSZ90a5a.mjs";
import { defineCSSCompletionSource as N } from "./index-BbAx2RMI.mjs";
...
function GO(O) {
  return new x(O != null && O.indented ? wO : P, P.data.of({ autocomplete: YO }));
}
export {
  GO as sass,
