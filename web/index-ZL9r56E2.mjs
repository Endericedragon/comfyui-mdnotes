import { P as nt, m as j, n as v, T as st, o as Ae, s as Be, p as it, t as c, q as I, E as ot, r as at, L as le, u as lt, v as ht, w as ft, x as ut, e as F, l as P, y as T, z as dt, f as Ee, i as pt, A as ct, C as mt, B as gt, D as he, F as kt } from "./main-BrUfuLnd.mjs";
import { html as Lt, htmlCompletionSource as bt } from "./index-CH8Efc5e.mjs";
class U {
  ...
  addChild(e, r) {
    e.prop(v.contextHash) != this.hash && (e = new I(e.type, e.children, e.positions, e.length, this.hashProp)), this.children.push(e), this.positions.push(r);
  }
  toTree(e, r = this.end) {
    let n = this.children.length - 1;
    return n >= 0 && (r = Math.max(r, this.positions[n] + this.children[n].length + this.from)), new I(e.types[this.type], this.children, this.positions, r - this.from).balance({
      makeTree: (s, i, o) => new I(j.none, s, i, o, this.hashProp)
    });
  }
}
var u;
...
const J = /^[ \t]*$/, ye = /-->/, Re = /\?>/, Y = [
  ...
  [/^\s*<![A-Z]/, />/],
  [/^\s*<!\[CDATA\[/, /\]\]>/],
  [/^\s*<\/?(?:address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h1|h2|h3|h4|h5|h6|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|nav|noframes|ol|optgroup|option|p|param|section|source|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul)(?:\s|\/?>|$)/i, J],
  [/^\s*(?:<\/[a-z][\w-]*\s*>|<[a-z][\w-]*(\s+[a-z:_][\w-.]*(?:\s*=\s*(?:[^\s"'=<>`]+|'[^']*'|"[^"]*"))?)*\s*>)\s*$/i, J]
];
function Oe(t, e, r) {
  if (t.next != 60)
    return -1;
  let n = t.text.slice(t.pos);
  for (let s = 0, i = Y.length - (r ? 1 : 0); s < i; s++)
    if (Y[s][0].test(n))
      return s;
  return -1;
}
...
const X = {
  ...
  HTMLBlock(t, e) {
    ...
    if (r < 0)
      return !1;
    let n = t.lineStart + e.pos, s = Y[r][1], i = [], o = s != J;
  ...
  advance(e) {
    for (; ; ) {
      ...
      if (this.stage == 0) {
        ...
        if (!this.nextStage(_e(e, R(e, this.pos), this.start)))
          return -1;
...
const Te = {
  LinkReference(t, e) {
    return e.content.charCodeAt(0) == 91 ? new Ct(e) : null;
  },
  SetextHeading() {
    return new xt();
  }
...
class Et {
  ...
  */
  constructor(e, r, n, s) {
    this.parser = e, this.input = r, this.ranges = s, this.line = new St(), this.atEnd = !1, this.reusePlaceholders = /* @__PURE__ */ new Map(), this.stoppedAt = null, this.rangeI = 0, this.to = s[s.length - 1].to, this.lineStart = this.absoluteLineStart = this.absoluteLineEnd = s[0].from, this.block = U.create(u.Document, 0, this.lineStart, 0, 0), this.stack = [this.block], this.fragments = n.length ? new Pt(n, r) : null, this.readLine();
  }
  get parsedPos() {
  ...
  advance() {
    ...
    let r = new wt(this.lineStart + e.pos, e.text.slice(e.pos));
...
`);
  ...
  */
  addNode(e, r, n) {
    typeof e == "number" && (e = new I(this.parser.nodeSet.types[e], N, N, (n ?? this.prevLineEnd()) - r)), this.block.addChild(e, r - this.block.from);
  }
  /**
  ...
  */
  addLeafElement(e, r) {
    this.addNode(this.buffer.writeElements(te(r.children, e.marks), -r.from).finish(r.type, r.to - r.from), r.from);
  }
  /**
  @internal
  */
  ...
  */
  finishLeaf(e) {
    for (let n of e.parsers)
      if (n.finish(this, e))
        return;
    let r = te(this.parser.parseInline(e.content, e.start), e.marks);
...
function ze(t, e, r, n, s) {
  ...
  return f(r.to + n, !1), new I(r.type, o, a, r.to + n - l, r.tree ? r.tree.propValues : void 0);
}
class q extends nt {
  /**
  @internal
    ...
    if (y(r.parseBlock))
      for (let d of r.parseBlock) {
        ...
        if (m > -1)
          ...
          let L = d.before ? $(a, d.before) : d.after ? $(a, d.after) + 1 : a.length - 1;
    ...
    if (y(r.parseInline))
      for (let d of r.parseInline) {
        ...
        if (m > -1)
          ...
          let L = d.before ? $(f, d.before) : d.after ? $(f, d.after) + 1 : f.length - 1;
...
const $e = { resolve: "Emphasis", mark: "EmphasisMark" }, Ue = { resolve: "Emphasis", mark: "EmphasisMark" }, H = {}, ee = {};
class C {
  constructor(e, r, n, s) {
...
const Z = {
  ...
  Emphasis(t, e, r) {
    ...
    return t.append(new C(e == 95 ? $e : Ue, r, n, (d ? 1 : 0) | (m ? 2 : 0)));
  },
  HardBreak(t, e, r) {
  ...
  LinkEnd(t, e, r) {
    ...
    for (let n = t.parts.length - 1; n >= 0; n--) {
      let s = t.parts[n];
      if (s instanceof C && (s.type == H || s.type == ee)) {
...
function It(t, e, r, n, s) {
  ...
  if (e.unshift(g(u.LinkMark, n, n + (r == u.Image ? 2 : 1))), e.push(g(u.LinkMark, s - 1, s)), o == 40) {
    ...
    f && (l = t.skipSpace(f.to), l != f.to && (h = je(i, l - t.offset, t.offset), h && (l = t.skipSpace(h.to)))), t.char(l) == 41 && (e.push(g(u.LinkMark, s, s + 1)), a = l + 1, f && e.push(f), h && e.push(h), e.push(g(u.LinkMark, l, a)));
  } else if (o == 91) {
  ...
  */
  get hasOpenLink() {
    for (let e = this.parts.length - 1; e >= 0; e--) {
      let r = this.parts[e];
      if (r instanceof C && (r.type == H || r.type == ee))
        return !0;
    }
    return !1;
  }
  ...
  resolveMarkers(e) {
    for (let n = e; n < this.parts.length; n++) {
      ...
      if (!(s instanceof C && s.type.resolve && s.side & 2))
        continue;
      let i = s.type == $e || s.type == Ue, o = s.to - s.from, a, l = n - 1;
      for (; l >= e; l--) {
        let k = this.parts[l];
...
function te(t, e) {
  ...
  for (let s of e) {
    ...
    if (n < r.length && r[n].from < s.from) {
      let i = r[n];
      i instanceof z && (r[n] = new z(i.type, i.from, i.to, te(i.children, [s])));
    } else
      r.splice(n++, 0, s);
  }
  return r;
  ...
  takeNodes(e) {
    ...
    for (; ; ) {
      ...
      if (r.to - n <= e.ranges[e.rangeI].to)
        ...
        let p = new I(e.parser.nodeSet.types[u.Paragraph], [], [], 0, e.block.hashProp);
        e.reusePlaceholders.set(p, r.tree), e.addNode(p, h);
      }
      if (r.type.is("Block") && (Ht.indexOf(r.type.id) < 0 ? (o = r.to - n, a = e.block.children.length) : (o = l, a = f, l = r.to - n, f = e.block.children.length)), !r.nextSibling())
        break;
    }
...
const vt = Be({
  ...
  LinkTitle: c.string,
  Paragraph: c.content
}), Nt = new q(new Ae(De).extend(vt), Object.keys(X).map((t) => X[t]), Object.keys(X).map((t) => Te[t]), Object.keys(X), At, Ie, Object.keys(Z).map((t) => Z[t]), Object.keys(Z), []);
function yt(t, e, r) {
  let n = [];
  ...
  parseBlock: [{
    ...
    endLeaf(t, e, r) {
      if (r.parsers.some((s) => s instanceof me) || !ce(e.text, e.basePos))
        return !1;
      let n = t.peekLine();
      return Ze.test(n) && O(t, e.text, e.basePos) == O(t, n, e.basePos);
    },
...
}, ge = /(www\.)|(https?:\/\/)|([\w.+-]{1,100}@)|(mailto:|xmpp:)/gy, ke = /[\w-]+(\.[\w-]+)+(\/[^\s<]*)?/gy, Xt = /[\w-]+\.[\w-]+($|\/)/, Le = /[\w.+-]+@[\w-]+(\.[\w.-]+)+/gy, be = /\/[a-zA-Z\d@.]+/gy;
function we(t, e, r, n) {
  let s = 0;
  for (let i = e; i < r; i++)
    t[i] == n && s++;
...
}, Ge = /* @__PURE__ */ ut({ commentTokens: { block: { open: "<!--", close: "-->" } } }), Ke = /* @__PURE__ */ new v(), Je = /* @__PURE__ */ Nt.configure({
  props: [
    /* @__PURE__ */ Ee.add((t) => !t.is("Block") || t.is("Document") || re(t) != null || Zt(t) ? void 0 : (e, r) => ({ from: r.doc.lineAt(e.from).to, to: e.to })),
    /* @__PURE__ */ Ke.add(re),
    /* @__PURE__ */ pt.add({
      Document: () => null
    }),
...
function Vt(t, e) {
  ...
  for (; ; ) {
    ...
    if (!n || (s = re(n.type)) != null && s <= e)
      break;
    r = n;
  }
  return r.to;
}
const Gt = /* @__PURE__ */ at.of((t, e, r) => {
...
function oe(t) {
  return new ft(Ge, t, [], "markdown");
}
const Kt = /* @__PURE__ */ oe(Je), Jt = /* @__PURE__ */ Je.configure([_t, qt, jt, Qt, {
  props: [
    /* @__PURE__ */ Ee.add({
...
function Ye(t, e) {
  ...
  for (let s = r.length - 1; s >= 0; s--) {
    ...
    if (i.name == "Blockquote" && (o = /^ *>( ?)/.exec(a.text.slice(l))))
      n.push(new V(i, l, l + o[0].length, "", o[1], ">", null));
    else if (i.name == "ListItem" && i.parent.name == "OrderedList" && (o = /^( *)\d+([.)])( *)/.exec(a.text.slice(l)))) {
      let f = o[3], h = o[0].length;
      f.length >= 4 && (f = f.slice(0, f.length - 4), h -= 4), n.push(new V(i.parent, l, l + h, o[1], f, o[2], i));
      ...
      let p = o[2];
      o[3] && (p += o[3].replace(/[xX]/, " ")), n.push(new V(i.parent, l, l + h, o[1], f, p, i));
    }
  }
  return n;
}
...
const Wt = ({ state: t, dispatch: e }) => {
  let r = F(t), { doc: n } = t, s = null, i = t.changeByRange((o) => {
    if (!o.empty || !_.isActiveAt(t, o.from, -1) && !_.isActiveAt(t, o.from, 1))
      return s = { range: o };
    ...
    for (; k > l.from && /\s/.test(l.text.charAt(k - l.from - 1)); )
      k--;
    return L = ae(L, t), er(h.node, t.doc) && (L = xe(f, t, l) + t.lineBreak + L), d.push({ from: k, to: a, insert: t.lineBreak + L }), { range: P.cursor(k + L.length + 1), changes: d };
  });
...
const rr = ({ state: t, dispatch: e }) => {
  let r = F(t), n = null, s = t.changeByRange((i) => {
    let o = i.from, { doc: a } = t;
    if (i.empty && _.isActiveAt(t, i.from)) {
      let l = a.lineAt(o), f = Ye(tr(r, o), a);
      if (f.length) {
...
function fr(t = {}) {
  let { codeLanguages: e, defaultCodeLanguage: r, addKeymap: n = !0, base: { parser: s } = Kt, completeHTMLTags: i = !0, pasteURLAsLink: o = !0, htmlTagLanguage: a = et } = t;
  if (!(s instanceof q))
    throw new RangeError("Base parser provided to `markdown` should be a Markdown parser");
  let l = t.extensions ? [t.extensions] : [], f = [a.support, Gt], h;
  o && f.push(ar), r instanceof le ? (f.push(r.support), h = r.language) : r && (h = r);
  let p = e || h ? Yt(e, h) : void 0;
  l.push(Rt({ codeParser: p, htmlParser: a.language.parser })), n && f.push(lt.high(ht.of(nr)));
  let d = oe(s.configure(l));
  return i && f.push(d.data.of({ autocomplete: sr })), new le(d, f);
}
function sr(t) {
...
function ir() {
  if (K)
    return K;
  let t = bt(new mt(gt.create({ extensions: et }), 0, !0));
  return K = t ? t.options : [];
}
const or = /code|horizontalrule|html|link|comment|processing|escape|entity|image|mark|url/i, ar = /* @__PURE__ */ ot.domEventHandlers({
  paste: (t, e) => {
    var r;
    ...
    if (!s || !/^(https?:\/\/|mailto:|xmpp:|www\.)/.test(s) || (/^www\./.test(s) && (s = "https://" + s), !_.isActiveAt(e.state, n.from, 1)))
      return !1;
    let i = F(e.state), o = !1;
    return i.iterate({
      from: n.from,
      to: n.to,
      enter: (a) => {
        (a.from > n.from || or.test(a.name)) && (o = !0);
      },
      leave: (a) => {
        a.to < n.to && (o = !0);
      }
...
export {
  ...
  rr as deleteMarkupBackward,
  Wt as insertNewlineContinueMarkup,
  fr as markdown,
  nr as markdownKeymap,
  _ as markdownLanguage,
  ar as pasteURLAsLink
};
