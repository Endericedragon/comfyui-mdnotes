import { L as he, E as $, C as be } from "./index-BWMv13vE.mjs";
import { p as Te, s as Pe, t as h, E as xe, a as Ve, L as ye, e as K, l as we, i as ve, f as Xe, G as $e } from "./main-DtGpgAMY.mjs";
import { cssLanguage as J, css as _e } from "./index-s_erkwn4.mjs";
import { typescriptLanguage as qe, jsxLanguage as Ce, tsxLanguage as ke, javascriptLanguage as M, javascript as Qe } from "./index-D_4Tj5-M.mjs";
...
const ot = [R, le, ee, te, ae], it = new be({
  start: null,
  shift(e, a, r, l) {
...
const pt = Z("script", Ae, Ye), mt = Z("style", Me, Re), ft = Z("textarea", Ee, Ze), gt = Pe({
  "Text RawText IncompleteTag IncompleteCloseTag": h.content,
      ...
      if (m) {
        for (let c of s)
          if (c.tag == m && (!c.attrs || c.attrs(O || (O = ie(d, u))))) {
            let S = p.lastChild, b = S.type.id == Ke ? S.from : p.to;
            if (b > d.to)
              return { parser: c.parser, overlay: [{ from: d.to, to: b }] };
          }
      }
    }
    if (o && f == ne) {
      ...
      if (d = p.firstChild) {
        ...
        if (m) for (let O of m) {
          ...
          let c = p.lastChild;
          if (c.type.id == A) {
            let S = c.from + 1, b = c.lastChild, T = c.to - (b && b.isError ? 0 : 1);
            if (T > S) return { parser: O.parser, overlay: [{ from: S, to: T }] };
...
const V = ["_blank", "_self", "_top", "_parent"], C = ["ascii", "utf-8", "utf-16", "latin1", "latin1"], k = ["get", "post", "put", "delete"], Q = ["application/x-www-form-urlencoded", "multipart/form-data", "text/plain"], g = ["true", "false"], n = {}, ht = {
  a: {
    attrs: {
      href: null,
      ping: null,
...
class y {
  constructor(a, r) {
    this.tags = { ...ht, ...a }, this.globalAttrs = { ...Oe, ...r }, this.allTags = Object.keys(this.tags), this.globalAttrNames = Object.keys(this.globalAttrs);
  }
}
...
].concat(/* @__PURE__ */ de.map((e) => ({ name: e, parser: M.parser }))), Se = /* @__PURE__ */ Ve.define({
  name: "html",
...
const H = /* @__PURE__ */ new Set(/* @__PURE__ */ "area base br col command embed frame hr img input keygen link meta param source track wbr menuitem".split(" ")), yt = /* @__PURE__ */ xe.inputHandler.of((e, a, r, l, t) => {
  ...
  let s = t(), { state: o } = s, i = o.changeByRange((u) => {
    ...
    if (m && l == ">" && c.name == "EndTag") {
      let b = c.parent;
      if (((p = (f = b.parent) === null || f === void 0 ? void 0 : f.lastChild) === null || p === void 0 ? void 0 : p.name) != "CloseTag" && (S = P(o.doc, b.parent, O)) && !H.has(S)) {
        let T = O + (o.doc.sliceString(O, O + 1) === ">" ? 1 : 0), w = `</${S}>`;
        return { range: u, changes: { from: O, to: T, insert: w } };
      }
    } else if (m && l == "/" && c.name == "IncompleteCloseTag") {
      let b = c.parent;
      if (c.from == O - 2 && ((d = b.lastChild) === null || d === void 0 ? void 0 : d.name) != "CloseTag" && (S = P(o.doc, b, O)) && !H.has(S)) {
        let T = O + (o.doc.sliceString(O, O + 1) === ">" ? 1 : 0), w = `${S}>`;
        return {
          range: we.cursor(O + w.length, -1),
